...
\item However, it is not a faithful formalization currently.  I defined forks using the \texttt{prepare\_src} aware chains, I didn't need slashing condidions one and two.
